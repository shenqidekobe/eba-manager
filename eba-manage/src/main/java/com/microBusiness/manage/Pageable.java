...
public class Pageable implements Serializable {
	...
	public Pageable(Integer pageNumber , Integer pageSize , boolean more) {
		if (pageNumber != null && pageNumber >= 1) {
			this.pageNumber = pageNumber;
		}
		if(more){
	...
	public void setPageSize(int pageSize , boolean isMore) {
		if(isMore){
	...
	public String getOrSearchValue() {
		return orSearchValue;
	}

	public void setOrSearchValue(String orSearchValue) {
		this.orSearchValue = orSearchValue;
	}
}