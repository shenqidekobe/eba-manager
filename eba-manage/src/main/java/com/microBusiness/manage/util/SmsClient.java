...
//		this.sn = Constant.SMS_SN;
//		this.password = Constant.SMS_PWD;
//		//密码为md5(sn+password)
...
//	}
	...
	private static String account = "dh21409";// 用户名（必填）
	private static String password = "21409.com";// 密码（必填）
	public static String sign = "【微商小管理】"; // 短信签名（必填）
...
//		
//		//String content = "短信测试嘻嘻嘻。";// 短信内容（必填）
//		
//		String content = "恭喜您成功开通微商小管理账号，您可微信搜索微商小管理小程序，登录订货。";
//		content = URLEncoder.encode(content , "utf-8");
////		mdsmssend("15221565503", content,  "",  "",
//				 "",  "");
//	
//		
//	}
	...
	public static String mdsmssend(String mobile, String content, String ext, String stime,
		...
		try {
			...
			String url  = "http://www.dh3t.com";
			JSONHttpClient jsonHttpClient = new JSONHttpClient(url);
			jsonHttpClient.setRetryCount(1);
			String sendhRes = jsonHttpClient.sendSms(account, password, mobile, content, sign, subcode, msgid);
