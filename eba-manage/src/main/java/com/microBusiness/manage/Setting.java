...
public class Setting implements Serializable {
	...
	@NotEmpty
	@Length(max = 200)
	public String getPosterUploadPath() {
		return posterUploadPath;
	}

	public void setPosterUploadPath(String posterUploadPath) {
		if (posterUploadPath != null) {
			if (!posterUploadPath.startsWith("/")) {
				posterUploadPath = "/" + posterUploadPath;
			}
			if (!posterUploadPath.endsWith("/")) {
				posterUploadPath += "/";
			}
		}
		this.posterUploadPath = posterUploadPath;
	}
