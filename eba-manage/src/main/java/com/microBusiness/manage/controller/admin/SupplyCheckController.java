...
/**
 * Created by mingbai on 2017/8/2.
 * 功能描述：商流发布的供应商品审核
 * 修改记录：
 */
@Controller
@RequestMapping("/admin/supplyCheck")
public class SupplyCheckController extends BaseController {
    ...
    public String list(ModelMap model, Pageable pageable , Long  categoryId, String searchValue , CompanyGoods.Status status) {
        ...
        Page<CompanyGoods> page = companyGoodsService.findPage(pageable , category , status , searchValue , CompanyGoods.PubType.pub_supply);
        ...
        return "/admin/supply_check/list";
    }
    ...
    public String edit(Long id, ModelMap model) {
        ...
        return "/admin/supply_check/edit";
    }
    ...
    public String view(Long id, ModelMap model) {
        ...
        return "/admin/supply_check/view";
    }
    ...
    public ModelAndView export(ModelMap model, Pageable pageable , Long  categoryId, String searchValue , CompanyGoods.Status status) {
        ...
        return new ModelAndView(companyGoodsService.exportSupplyGoods(pageable , categoryId , status , searchValue , CompanyGoods.PubType.pub_supply));
    }
