...
<title>${message("admin.plugin.alipayEscowPayment.setting")} - Powered By DreamForYou</title>
		...
		<table class="input">
			...
			<tr>
				...
				<td>
					...
					<a href="http://bizpartner.alipay.com/utlz/" target="_blank">[${message("admin.plugin.alipayEscowPayment.register")}]</a>
