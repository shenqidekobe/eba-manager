...
<title>${message("admin.plugin.alipayDualPayment.setting")} - Powered By DreamForYou</title>
		...
		<table class="input">
			...
			<tr>
				...
				<td>
					...
					<a href="http://bizpartner.alipay.com/utlz/" target="_blank">[${message("admin.plugin.alipayDualPayment.register")}]</a>
