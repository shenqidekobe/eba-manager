...
@Entity
@Table(name = "xx_goods_import_image_info")
@SequenceGenerator(name = "sequenceGenerator", sequenceName = "seq_goods_import_image_info")
public class GoodsImportImageInfo extends BaseEntity<Long> {
	private static final long serialVersionUID = -5461475541622028755L;
