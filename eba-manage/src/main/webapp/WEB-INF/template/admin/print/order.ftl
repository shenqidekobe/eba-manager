...
<body>
	...
	<div class="content">
		<div style="text-align: center;font-size: large">配货单</div>
        <table class="input1">
            <tr>
                <th>
				供应商:
            ...
            <tr>
         	...
         	${message("Shipping.deliveryCode")}
                ...
                <td>
					${order.deliveryCode}<span class="silver">(此码为司机送货确认码，请勿向其他人透露)</span>
                </td>
            </tr>
...
<div style="text-align: center;font-size: large">商品信息</div>
