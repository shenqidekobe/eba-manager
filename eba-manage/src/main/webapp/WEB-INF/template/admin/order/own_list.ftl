...
<body>
	<div class="breadcrumb">
		<a href="${base}/admin/common/index.jhtml">${message("admin.breadcrumb.home")}</a> &raquo; 采购单 <span>(${message("admin.page.total", page.total)})</span>
	</div>
		...
		<div class="bar">
			<div class="buttonGroup">
                <a href="add.jhtml" class="iconButton">
                    <span class="addIcon">&nbsp;</span>收货点代下单
                </a>

                <a href="addMore.jhtml" class="iconButton">
                    <span class="addIcon">&nbsp;</span>多地址代下单
                </a>

				<a href="javascript:;" id="refreshButton" class="iconButton">
					<span class="refreshIcon">&nbsp;</span>${message("admin.common.refresh")}
				</a>
                <a href="javascript:;" id="downButton" class="iconButton">
                    导出
                </a>
				...
				<div id="filterMenu" class="dropdownMenu">
					...
					<ul class="check">
						[#--[#list statuses as value]
                            <li name="status"[#if value == status] class="checked"[/#if] val="${value}">${message("Order.Status." + value)}</li>
						[/#list]--]
				...
				<a href="javascript:;" id="moreButton" class="button"  style="display: none">${message("admin.order.moreOption")}</a>
			...
			收货日期:
            <input type="text" id="startDate" name="startDate" class="text Wdate" value="${(startDate?string("yyyy-MM-dd"))!}" style="width: 120px;" onfocus="WdatePicker({maxDate: '#F{$dp.$D(\'endDate\')}'});" />
			至
            <input type="text" id="endDate" name="endDate" class="text Wdate" value="${(endDate?string("yyyy-MM-dd"))!}" style="width: 120px;" onfocus="WdatePicker({minDate: '#F{$dp.$D(\'startDate\')}'});" />
