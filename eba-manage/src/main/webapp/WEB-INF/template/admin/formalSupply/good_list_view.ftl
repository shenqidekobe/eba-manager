		...
		<table id="listTable" class="list">
			...
			[#list page.content as goods]
				<tr>
					...
					<td>
						[#list goods.supplierProducts as supplierProducts]
							[#list supplierProducts.products.specificationValues as specificationValue]
								${specificationValue.value}&nbsp;
							[/#list]
						${currency(supplierProducts.products.price, true)}<br />
						[/#list]
					</td>

                    <td>
						[#list goods.supplierProducts as supplierProducts]
							${supplierProducts.supplyPrice}
                            <br />
						[/#list]
                    </td>
				</tr>
