...
<div class="child_page"><!--内容外面的大框-->
    <div class="cus_nav">
        <ul>
            ...
            <li>${message("admin.adPosition.edit")}</li>
        </ul>
    </div>
            ...
            <div class="pag_div">
                ...
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-8 col-sm-7">
                        <input type="text" class="input-text radius" name="name" maxlength="200" value="${adPosition.name}">
                    </div>
                </div>
                <div class="row cl">
                    <label class="form-label col-xs-4 col-sm-3">
                    ...
                    <div class="formControls col-xs-8 col-sm-7">
                        <input type="text" class="input-text radius" name="width" maxlength="9" value="${adPosition.width}">
                    </div>
                </div>
                <div class="row cl">
                    <label class="form-label col-xs-4 col-sm-3">
                    ...
                    <div class="formControls col-xs-8 col-sm-7">
                        <input type="text" class="input-text radius" name="height" maxlength="9" value="${adPosition.height}"/>
                    </div>
                </div>
                <div class="row cl">
                    <label class="form-label col-xs-4 col-sm-3">
                    ...
                    <div class="formControls col-xs-8 col-sm-7">
                        <input type="text" class="input-text radius" placeholder="" name="description" maxlength="200" value="${adPosition.description}"/>
                    </div>
                </div>
                <div class="row cl">
                    <label class="form-label col-xs-4 col-sm-3">
                    ...
                    <div class="formControls col-xs-8 col-sm-7">
                        ...
                        <textarea rows="5" class="text_area" cols="50" rows="5" name="template" placeholder="" >${adPosition.template}</textarea>
                    </div>
                </div>
