...
<div class="child_page"><!--内容外面的大框-->
    ...
    <div class="form_box" style="overflow: auto;">
        <form action="createFormal.jhtml" id="inputForm" method="post" class="form form-horizontal">
            <div class="pag_div">
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $("#addPro").click(function () {
            ...
            var contentPath = "../utils/proListFormal.jhtml?supplierId=" + supplierId + "&needId=" + needId;
