	                        ...
	                        <div class="formControls col-xs-8 col-sm-7">
	                            ...
	                            <ul class="downList_con">
	                                [#list productCategoryTree as productCategory]
	                                    <li val="${productCategory.id}"  [#if productCategory == goods.categoryCenter] class="li_bag"[/#if]>[#if productCategory.grade != 0][#list 1..productCategory.grade as i]&nbsp;&nbsp;[/#list][/#if]${productCategory.name}</li>
	                                [/#list]
	                            </ul>
	                        </div>
                        [/#if]
                        ...
                        <div class="formControls col-xs-8 col-sm-7">
                            ...
                            <div class="updateDivImgs displayArrImg">
                                ...
                                <div class="updateImg">
                                    ...
                                    <input type="hidden" name="images" value="${goods.images?join(",")}"/>
...
<script type="text/javascript">
    $().ready(function() {
        ...
        [#if goods.hasSpecification()]
            [#list goods.productCenters as product]
                initProductValues["${product.specificationValueIds?join(",")}"] = {
                    ...
                    rewardPoint: ${product.rewardPoint!0},
                    exchangePoint: ${product.exchangePoint!0},
