...
<div class="order-box">
    <div class="tab-top [#if isDistributionModel != 'true'] twoBu_top [/#if]">
        <ul class="tab-ul orderClass">
            <li class="tab-item"><a data-order="order" href="javascript:;">订货单</a></li>
            <li class="tab-item tab-active"><a data-order="ownOrder" href="javascript:;">采购单</a></li>
        ...
        <div class="search-box">
            <div class="search-con">
                ...
                <div class="search-text">
                    <input type="text" class="search-detail" id="searchName" name="searchName" value="${searchName}" maxlength="200" placeholder="请输入编号/客户名称" readonly="readonly" onclick="goSearch()" />
                </div>
            </div>
        </div>
...
//    document.addEventListener('DOMContentLoaded', loaded, false);
    ...
    function goSearch(){
        var status=$("#status").val();
        window.location.href="search.jhtml?status="+status;
    }
