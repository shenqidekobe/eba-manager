		...
		<div class="child_page"><!--内容外面的大框-->	
			<div class="cus_nav">
				<ul>
					...
					<li>采购审核 <span>(${message("admin.page.total", page.total)})</span></li>
				</ul>
			</div>
					...
					<table class="table table-border table-hover table_width">
						<thead>
							<tr class="text-l">
                                ...
                                <th width="10%"><div class="th_div">采购数</div></th>
						...
						<tbody>
							...
							<tr class="text-l">
								...
								<td class="td-manage">
									<a title="${message("admin.common.view")}" href="/shop/companyGoods/companyGoodsLook.jhtml?pubType=pub_need&id=${goods.id}" class="ml-5" style="text-decoration:none" target="_blank"><i class="operation_icon icon_see"></i></a>
