...
<body >
    <form id="inputForm" action="update.jhtml" method="post" class="form form-horizontal">
        <input type="hidden" name="id" id="id" value="${assGoodDirectory.id}">
                    ...
                    <div class="pag_div">
                        <div class="row cl">
                            ...
                            <div class="formControls col-xs-8 col-sm-7">
                                <span class="input_no_span" style="color:#333">${assGoodDirectory.theme}</span>
                            </div>
                        </div>
                        ...
                        <div class="row cl">
                            ...
                            <div class="formControls col-xs-8 col-sm-7">
                                <span class="fieldSet">
                                    <textarea class="text_area1" id="profiles" name="profiles">${assGoodDirectory.profiles}</textarea>
                                </span>
                            </div>
                        </div>
                    </div>
        ...
        $(function(){
            ...
            $(".form_box").css("height",formHeight);
             ...
             $("#yes").on("click",function(){
                ...
                $.post("update.jhtml",param,function(message){
                    $.message(message);
