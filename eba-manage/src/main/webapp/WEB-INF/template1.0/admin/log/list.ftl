...
<html>
	...
	<body >
		<div class="child_page"><!--内容外面的大框-->	
			<div class="cus_nav">
				<ul>
					<li>日志列表<span>(${message("admin.page.total", page.total)})</span></li>
				</ul>
			</div>
			...
			<div class="ch_condition">
				<div class="ch_search">
					...
					<div class="search_input">
						<input type="text" id="operator" name="operator" value="${operator}" maxlength="200" placeholder="请输入操作人" />
					</div>
				</div>
				<div class="ch_search">
					<div class="search_input">
						<input type="text" id="ip" name="ip" value="${ip}" maxlength="200" placeholder="请输入操作IP" />
					</div>
				</div>
				
				<div>
					<div class="drop_down" id="dropDown">
						<span class="timeType">操作时间</span>
						<ul class="check">
			...
			<div class="table_con">
				...
				<div class="list_t_tbody" id="listTable">
					<table class="table table-border table-hover table_width">
					    <thead>
							<tr class="text-l">
								<th width="10%"><div class="th_div">操作人</div></th>
								<th width="20%"><div class="th_div">操作类型</div></th>
								<th width="20%"><div class="th_div">操作IP</div></th>
								<th width="15%"><div class="th_div">操作时间</div></th>
						...
						[#list page.content as log]
							<tr class="text-l">
								...
								<td class="td-manage">
								   <a title="${message("admin.common.view")}" href="view.jhtml?id=${log.id}" class="ml-5" style="text-decoration:none"><i class="operation_icon icon_see"></i></a>
								</td>
							</tr>
						[/#list]
						</tbody>
