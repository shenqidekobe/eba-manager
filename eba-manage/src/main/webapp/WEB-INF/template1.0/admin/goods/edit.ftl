...
<form id="inputForm" action="update.jhtml" method="post" class="form form-horizontal">
    ...
    <input type="hidden" id="supplyStatus" name="supplyStatus" value="${supplyStatus}">
    
    <input type="hidden" id="isAd" name="isAd" value="${goods.isAd}" />
    <input type="hidden" id="isVideoAd" name="isVideoAd" value="${goods.isVideoAd}" />
    <input type="hidden" id="isMainSell" name="isMainSell" value="${goods.isMainSell}" />
    
    <input type="hidden" id="isActivity1" name="isActivity1" value="${goods.isActivity1}" />
    <input type="hidden" id="isActivity2" name="isActivity2" value="${goods.isActivity2}" />
    <input type="hidden" id="isActivity3" name="isActivity3" value="${goods.isActivity3}" />
    <input type="hidden" id="isActivity4" name="isActivity4" value="${goods.isActivity4}" />
    
    <input type="hidden" id="isProxy" name="isProxy" value="${goods.isProxy}" />
    
    <input type="hidden" id="is2Member" name="is2Member" value="${goods.is2Member}" />
    ...
    <div class="child_page">
        <div class="cus_nav">
            <ul>
                ...
                <li>${message("admin.goods.edit")}</li>
            </ul>
        </div>
        <div class="form_box">
            ...
            <div class='form_baseInfo'>
                ...
                <div class="pag_div">
                    <div class="row cl">
                        ...
                        [#else]
	                        <div class="formControls col-xs-8 col-sm-7">
	                            ...
	                            <input type="text" id="productCategoryId" name="productCategoryId" class="downList_val" value="" />
	                            <ul class="downList_con">
	                                [#list productCategoryTree as productCategory]
	                                    <li val="${productCategory.id}"  [#if productCategory == goods.productCategory] class="li_bag"[/#if]>[#if productCategory.grade != 0][#list 1..productCategory.grade as i]&nbsp;&nbsp;[/#list][/#if]${productCategory.name}</li>
	                                [/#list]
	                            </ul>
	                        </div>
                        [/#if]
                    ...
                    <!--<div class="row cl">
                        ...
                        <div class="formControls col-xs-8 col-sm-7">
                            <input type="text" class="input-text radius" placeholder="" name="caption" value="${goods.caption}" />
                        </div>
                    </div>-->
                    ...
                    <div class="row cl">
                        ...
                        <div class="formControls col-xs-8 col-sm-7">
                            <div class="input_box">
                                <input type="text" name="weight" class="" value="${goods.weight}"/>
                                <div class="box_right input_right">
                                    <input type="text" readonly="readonly" class="weight_unit" value="" />
                                    <input type="text" name="weightUnit" class="downList_val" value=""/>
                                    <ul>
                                    [#list weightUnits as weightUnit]
                                        <li val="${weightUnit}" [#if weightUnit == goods.weightUnit]class="li_bag"[/#if]>${message("Goods.weightUnit."+weightUnit)}</li>
                                    [/#list]
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="row cl">
                        ...
                        [#--<span class="select-box">
                            ...
                            <ul class="downList_con">
                                ...
                                [#list natures as nature]
                                    <li val="${nature}" [#if nature == goods.nature]class="li_bag"[/#if]>${message("Goods.nature."+nature)}</li>
                                [/#list]
                    ...
                    <div class="row cl">
                        ...
                        [#--<span class="input_no_span">4374837447832</span>--]
                            <input type="text" name="product.cost" id="cost" class="input-text" maxlength="100" value="${goods.defaultProduct.cost}" />
                        </div>
                    </div>
                    ...
                    <div class="row cl">
                        ...
                        <div class="formControls col-xs-8 col-sm-7">
                        [#--<span class="input_no_span">4374837447832</span>--]
                            <input type="text" id="barCode" name="product.barCode" class="input-text" maxlength="50"  value="${goods.defaultProduct.barCode}" />
                        </div>
                    </div>
				    ...
				    [#else]
				             <div class="row cl">
		                        ...
		                        <div class="formControls col-xs-8 col-sm-7">
		                            <input type="text" name="product.minOrderQuantity" id="minOrderQuantity" class="input-text" maxlength="100" value="${goods.defaultProduct.minOrderQuantity}"/>
		                        </div>
		                    </div>
		                    ...
		                    <div class="row cl">
		                        ...
		                        <div class="formControls col-xs-8 col-sm-7">
		                            <input type="text" name="product.addValue" id="addValue" class="input-text" maxlength="100" value="${goods.defaultProduct.addValue}"/>
		                        </div>
		                    </div>
				    [/#if]
                ...
                <div class="pag_div">
                    <div class="row cl">
                        ...
                        <div class="formControls col-xs-8 col-sm-7">
                        	<input type="hidden" name="oldName" id="oldName" value="${goods.name}"/>
                            <input type="text" class="input-text radius" placeholder="" name="name" value="${goods.name}" />
                        </div>
                    </div>
                        ...
                        <div class="formControls col-xs-8 col-sm-7">
                            ...
                            <div class="updateDivImgs displayArrImg">
                                ...
                                <div class="updateImg">
                                    ...
                                    <input type="hidden" name="images" value="${goods.images}"/>
                    ...
                    <div class="row cl">
                        ...
                        <div class="formControls col-xs-8 col-sm-7">
                            <input type="text" class="input-text radius" placeholder="" name="packagesNum" value="${goods.packagesNum}" />
                        </div>
                    </div>
                    <div class="row cl">
                        ...
                        <div class="formControls col-xs-8 col-sm-7">
									[#--<span class="select-box">
                                        ...
                                        <ul class="downList_con">
                                            <li val="">${message("admin.common.choose")}</li>
                                            [#list units as unit]
                                                <li val="${unit}" [#if unit == goods.unit]class="li_bag"[/#if]>${message("Goods.unit."+unit)}</li>
                                            [/#list]
									...
									[#--<span class="select-box">
                                        ...
                                        <ul class="downList_con">
                                            ...
                                            [#list storageConditions as storageCondition]
                                                <li val="${storageCondition}" [#if storageCondition == goods.storageConditions]class="li_bag"[/#if]>${message("Goods.storageConditions."+storageCondition)}</li>
                                            [/#list]
                    ...
                    <div class="row cl">
                        ...
                        <div class="formControls col-xs-8 col-sm-7">
                            <div class="input_box">
                                <input type="text" class="" name="volume" value="${goods.volume}"/>
                                <div class="box_right input_right">
                                    ...
                                    <ul>
                                        [#list volumeUnits as volumeUnit]
                                            <li val="${volumeUnit}" [#if volumeUnit == goods.volumeUnit]class="li_bag"[/#if]>${message("Goods.volume." + volumeUnit)}</li>
                                        [/#list]
                                    </ul>
                                </div>
                            </div>
                    ...
                    <div class="row cl" style="display: none;">
                        ...
                        <div class="formControls col-xs-8 col-sm-7">
                            <input type="text" id="marketPrice" name="product.marketPrice" class="input-text radius" placeholder="" value="${goods.defaultProduct.marketPrice}">
                        </div>
                    </div>
                    ...
                    <div class="row cl">
                        ...
                        <div class="formControls col-xs-8 col-sm-7">
                        	 [#list actList as ad]
                                    <span id="isActivity${ad_index}Label" class="isActLabel isInLabel">${ad.title}</span>
                             [/#list]
                        </div>
                    </div>
                    ...
                    <div class="row cl">
                        ...
                        <div class="formControls col-xs-8 col-sm-7">
                            <input type="text" id="rate1" name="rate1" class="input-text radius" placeholder="" value="${goods.rate1}">
                        </div>
                    </div>
                    ...
                    <div class="row cl">
                        ...
                        <div class="formControls col-xs-8 col-sm-7">
                            <input type="text" id="rate2" name="rate2" class="input-text radius" placeholder="" value="${goods.rate2}">
                        </div>
                    </div>
                    ...
                    <div class="row cl">
                        ...
                        <div class="formControls col-xs-8 col-sm-7">
                            <input type="text" id="rate3" name="rate3" class="input-text radius" placeholder="" value="${goods.rate3}">
                        </div>
                    </div>
            ...
            <div class="form_spec">
                ...
                <div id="specificationTable" class="spec_list" style="width:100%">
                [#--<div class="row cl">
...
<script type="text/javascript">
    $().ready(function() {
        ...
        if($("#isAd").val() == 'true'){
        	$(".isAdLabel").addClass(colorClass);
        }
        
        if($("#isVideoAd").val() == 'true'){
            $(".isVideoAdLabel").addClass(colorClass);
        }
        
        if($("#isMainSell").val() == 'true'){
            $(".isMainSellLabel").addClass(colorClass);
        }
        
        
        if($("#isActivity1").val() == 'true'){
            $("#isActivity0Label").addClass(colorClass);
        }
        
        if($("#isActivity2").val() == 'true'){
            $("#isActivity1Label").addClass(colorClass);
        }
        
        if($("#isActivity3").val() == 'true'){
            $("#isActivity2Label").addClass(colorClass);
        }
        
        if($("#isActivity4").val() == 'true'){
            $("#isActivity3Label").addClass(colorClass);
        }
        
        if($("#is2Member").val() == 'true'){
            $(".isMemberGoodsLabel").addClass(proxyColor);
        }
        ...
        if($(".labelInput").length>0){
            for(var k=0; k<$(".labelInput").length;k++){
                labels.push($(".labelInput").eq(k).val());
            }
            $("#labels").val(labels);
        }
        ...
        for(var i=0; i<colorArr.length;i++){
            for(var j=0; j<labels.length;j++){
                if(colorArr[i] == labels[j]){
                    $(".labelSpan").eq(i).addClass(colorArr[i]);
                    console.log(i);
		...
		$("input[name=images]").val(imgsString);
        if(imgsString != ''){
        ...
        $(".displayImg .delImg").on("click",function(){
            var imgsString = $("input[name=images]").val();
            imgsString = imgsString.replace(/[\[|\]]/gi,'');
            var imgsArr = imgsString.split(',');
        ...
        [#if goods.hasSpecification()]
            [#list goods.products as product]
                initProductValues["${product.specificationValueIds?join(",")}"] = {
                    ...
                    addValue: ${product.addValue!"null"}
        ...
        $titleTr.append(
            ...
            $productTr.append(
                [@compress single_line = true]
                        '<td><input type="text" name="productList[' + i + '].barCode" class="price_form_p text" value="' + barCode + '" maxlength="50"  \/><\/td>'+
                ...
                <p class="price_form_p">
                        <span>￥<\/span>
                <input type="text" name="productList[' + i + '].proxyPrice" class="text proxyPrice" value="' + proxyPrice + '" maxlength="16"  \/>
                    <\/p>
                <\/td>
                <td>
                <p class="price_form_p">
                ...
                <\/td>
                <td class="">
                        <input type="text" name="productList[' + i + '].minOrderQuantity" class="text minOrderQuantity" value="' + minOrderQuantity + '" maxlength="9" style="width: 50px;" \/>
                <\/td>
                <td class="">
                        <input type="text" name="productList[' + i + '].addValue" class="text addValue" value="' + addValue + '" maxlength="9" style="width: 50px;" \/>
                <\/td>
                <td>
