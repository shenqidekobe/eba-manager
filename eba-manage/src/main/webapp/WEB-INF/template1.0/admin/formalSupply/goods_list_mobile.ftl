                ...
                <li class="good-li">
                    ...
                    <div class="order-info">
                        <div class="order-count">
                            ...
                            <input type="number" name="minOrderQuantity" class="count" min="1" value="1" placeholder="请输入" />
                        </div>
                        <div class="order-price">
                            <span class="name">供货价(￥)</span>
                            <input type="number" name="supplyPrice" class="price" min="0" value="${product.price}" placeholder="请输入"/>
                        </div>
                    </div>
                </li>
            [/#list]
