INSERT INTO `xx_admin` (`id`, `create_date`, `deleted`, `modify_date`, `version`, `bind_phone_num`, `boot_page`, `email`, `is_enabled`, `is_locked`, `is_system`, `lock_key`, `locked_date`, `login_date`, `login_failure_count`, `login_ip`, `name`, `password`, `prompts`, `username`, `department`, `supplier`) VALUES (1, '2018-12-16 21:40:58', b'0', '2018-12-26 14:53:02', 181, '18880809203', 0, NULL, b'1', b'0', b'1', '50943e002c993e84b7385d93867ce388', NULL, '2018-10-26 14:53:02', 0, '114.94.199.166', NULL, '1dc356b4741fb72a7fa35389e4502d5c', 0, 'admin', NULL, 1);

INSERT INTO `t_supplier` (`id`, `create_date`, `deleted`, `modify_date`, `version`, `address`, `app_id`, `app_key`, `business_card`, `company_profile`, `customer_service_tel`, `email`, `imagelogo`, `industry`, `invite_code`, `legal_person_name`, `name`, `probation_days`, `qq_customer_service`, `reasons`, `recommend_flag`, `status`, `tel`, `types`, `user_name`, `area`, `member`) VALUES (1, '2018-12-16 21:40:58', b'0', '2018-12-16 21:40:58', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'UDR926', NULL, '特宜总经办', 60000, NULL, NULL, NULL, 3, NULL, 0, NULL, NULL, NULL);


INSERT INTO `t_system_setting` (`id`, `create_date`, `deleted`, `modify_date`, `version`, `is_distribution_model`, `supplier`) VALUES (1, '2018-10-31 12:47:53', b'0', '2018-10-31 12:47:53', 0, b'0', 1);


INSERT INTO `xx_role` (`id`, `create_date`, `modify_date`, `version`, `authorities`, `description`, `is_system`, `name`, `switchs`, `supplier`, `deleted`) 
VALUES (1, '2018-12-17 12:50:58', '2018-12-17 12:50:58', 0, '["admin:homePage","admin:productCategory:list","admin:productCategory:add","admin:productCategory:edit","admin:productCategory:delete","admin:specification:list","admin:specification:add","admin:specification:edit","admin:specification:delete","admin:goods:list","admin:goods:add","admin:goods:edit","admin:goods:delete","admin:order:list","admin:order:review","admin:order:updateItems","admin:order:shipping","admin:order:addRemarks","admin:order:cancel","admin:order:complete","admin:orderReport:orderList","admin:commodityReport:orderForm","admin:ad","admin:adPosition","admin:member:list","admin:member:edit","admin:member:income","admin:withdraw:list","admin:withdraw:edit","admin:role:list","admin:role:add","admin:role:edit","admin:role:delete","admin:department:list","admin:department:add","admin:department:edit","admin:department:delete","admin:admin:list","admin:admin:add","admin:admin:edit","admin:admin:delete","admin:dict:edit","admin:ver:list","admin:ver:add","admin:ver:impl","admin:log"]', '系统管理员', b'0', '总经办', NULL, 1, b'0');
...
INSERT INTO `xx_dict` (`id`, `create_date`, `modify_date`, `version`, `json`, `deleted`) VALUES (100, '2018-03-27 13:52:48', '2018-03-27 13:52:48', 0, '{"platina_rate1":"0.25","platina_rate2":"0.075","platina_buy_amount":null,"platina_buy_rate":null,"platinum_to":"5000","platinum_rate1":"0.30","platinum_rate2":"0.09","platinum_buy_amount":"3000","platinum_buy_rate":"0.30","blackplatinum_to":"35000","blackplatinum_rate1":"0.35","blackplatinum_rate2":"0.105","blackplatinum_buy_amount":"5000","blackplatinum_buy_rate":"0.35","levelDist":2,"intervalDayCommision":15,"buySSRakeBack":false,"blackplatinumBuyNoAs":false}', b'0');
