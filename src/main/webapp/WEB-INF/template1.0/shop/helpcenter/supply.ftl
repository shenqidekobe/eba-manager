			...
			<div class="dh-nav-bar-selected">
		        <div class="nav-bar-con">
		            <div class="nav-bar">
		                ...
		                <i>/</i>
		                <a class="nav-bar-active nav-type" href="javascript:void(0);" target="_self" title="如何发布供应">如何发布供应</a>
			...
			<div class="con_center">
				<div class="nav">
					<ul class="nav_ul">
						...
						<li class="li_hover nav_selected"><a href="/shop/jumpPubType.jhtml?pubType=pub_supply">如何发布供应</a></li>
						<li class="li_hover"><a href="/shop/jumpPubType.jhtml?pubType=pub_need">如何发布采购</a></li>
					</ul>
				</div>
				<div class="content">
					<form action="">
					<div class="conList">
						<div class="content_box">
							...
							<img src="${base}/resources/shop/common/images/gongying.jpg" alt="" />
