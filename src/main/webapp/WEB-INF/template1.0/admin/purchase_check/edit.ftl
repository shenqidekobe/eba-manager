...
<form id="inputForm" action="update.jhtml" method="post" class="form form-horizontal">
    ...
    <div class="child_page">
        <div class="cus_nav">
            <ul>
            	...
            	<li><a href="list.jhtml">采购审核</a></li>
                <li>编辑</li>
            </ul>
        </div>
        <div class="form_box">
                ...
                <div class="pag_div">
                    ...
                    <div class="row cl">
                        ...
                        <div class="formControls col-xs-8 col-sm-7 type_radio">
                            [#list sourceTypes as sourceType]
                                <label>
                                    <input name="sourceType" type="radio" value="${sourceType}" [#if goods.sourceType == sourceType]checked[/#if]><span>${sourceType.getName()}</span>
                                </label>
                            [/#list]
                        </div>
                    </div>
                    ...
                    <div class="row cl">
                        ...
                        [#--<span class="input_no_span">4374837447832</span>--]
                            <input type="text" name="goodsSpec" id="goodsSpec" class="input-text radius" value="${goods.goodsSpec}" />
                        </div>
                    </div>
                ...
                <div class="pag_div">
                    ...
                    <div class="row cl">
                        <label class="form-label col-xs-4 col-sm-3"><img
                                src="${base}/resources/admin1.0/images/bitian_icon.svg" alt=""/>采购数</label>
                        <div class="formControls col-xs-8 col-sm-7 res_price">
                            <div class="input-group">
                            	<span class="symbol">￥</span>
                                <input name="needNum" id="needNum" type="hidden" value="${goods.needNum}"/>
                                <input name="needNumShow" id="needNumShow" type="text" class="form-control" value="[#if goods.needNum != -1]${goods.needNum}[/#if]"/>
    ...
    <div class="footer_submit">
        <input class="btn radius confir_S" type="button" id="passButton" onclick="javascript:submitForm('status_ok');" value="审核通过" />
        <input class="btn radius cancel_B" type="button" id="unPassButton" onclick="javascript:submitForm('status_rej');" value="审核不通过" />
    </div>
</form>
...
<script type="text/javascript">
    ...
    $().ready(function() {
		...
		$("#needNumShow").on("input propertychange", function () {
            if ($(this).val().length) {
        ...
        $("#needNumRadio").on("click", function () {
            if ($(this).prop("checked")) {
                $("#needNumShow").siblings(".error").css("display", "none");
                $("#needNumShow").val("");
            }
