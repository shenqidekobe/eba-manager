...
<html>
	<head>
		<meta charset="UTF-8">
		<title>编辑部门 - Powered By DreamForYou</title>
					...
					<div class="pag_div">
						...
						<div class="row cl">
							...
							<div class="formControls col-xs-8 col-sm-7">
								<input type="text" class="input-text radius" name="name" id="name" value="${department.name}" maxlength="200" />
							</div>
						</div>
						<div class="row cl">
							...
							<div class="formControls col-xs-8 col-sm-7"> 
								...
								<ul class="downList_con">
									[#list departmentTree as dep]
									<li val="${dep.id}" [#if dep == department.parent] class="li_bag"[/#if]>[#if dep.grade != 0][#list 1..dep.grade as i]&nbsp;&nbsp;[/#list][/#if]${dep.name}</li>
									[/#list]
								</ul>
							</div>
						</div>
                        <div class="row cl">
                            ...
                            <div class="formControls col-xs-8 col-sm-7">
                                <input type="text" class="input-text radius" name="order" value="${department.order}" maxlength="9"/>
                            </div>
                        </div>
					</div>
