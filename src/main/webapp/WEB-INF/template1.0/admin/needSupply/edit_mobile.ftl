...
<div class="choose-customer">
    ...
    <div class="info-top">
        <div class="info-time li_jiantou">
            ...
            <input type="text" id="startDate" name="startDate" value="${supplyNeed.startDate}" class="chooseDate time" placeholder="请选择开始时间 必选" unselectable="on" onfocus="this.blur()" readonly="readonly">
        </div>
        <div class="info-time li_jiantou">
            <div class="end-name">结束时间</div>
            <input type="text" id="endDate" name="endDate" value="${supplyNeed.endDate}" class="chooseDate time" placeholder="请选择结束时间 必选" unselectable="on" onfocus="this.blur()" readonly="readonly">
        </div>
    ...
    <div class="confirm-box">
        ...
        <div class="confirm" id="yes">确定</div>
    </div>
