				...
				<form id="inputForm" action="update.jhtml" method="post" class="form form-horizontal">
					...
					<div class="pag_div">
						...
						<div class="row cl">
							...
							<div class="formControls col-xs-8 col-sm-7">
								<input type="text" class="input-text radius" name="name" id="name" value="${editCategory.name}" maxlength="200" />
							</div>
						</div>
						<div class="row cl">
							...
							<div class="formControls col-xs-8 col-sm-7"> 
								...
								<ul class="downList_con">
									...
									<li val="${category.id}" [#if category == editCategory.parent] class="li_bag"[/#if]>[#if category.grade != 0][#list 1..category.grade as i]&nbsp;&nbsp;[/#list][/#if]${category.name}</li>
									[/#list]
								</ul>
							</div>
						</div>
					...
					<div class="pag_div">
						...
						<div class="row cl">
							...
							<div class="formControls col-xs-8 col-sm-7">
								<input type="text" class="input-text radius" name="seoTitle" value="${editCategory.seoTitle}" maxlength="200"/>
							</div>
						</div>
						<div class="row cl">
							<label class="form-label col-xs-4 col-sm-3">${message("ProductCategory.seoKeywords")}</label>
							<div class="formControls col-xs-8 col-sm-7">
								<input type="text" class="input-text radius" name="seoKeywords" value="${editCategory.seoKeywords}" maxlength="200"/>
							</div>
						</div>
						<div class="row cl">
							<label class="form-label col-xs-4 col-sm-3">${message("ProductCategory.seoDescription")}</label>
							<div class="formControls col-xs-8 col-sm-7">
								<input type="text" class="input-text radius" name="seoDescription" value="${editCategory.seoDescription}" />
							</div>
						</div>
						<div class="row cl">
							<label class="form-label col-xs-4 col-sm-3">${message("admin.common.order")}</label>
							<div class="formControls col-xs-8 col-sm-7">
								<input type="text" class="input-text radius" name="order" value="${editCategory.order}" maxlength="9"/>
							</div>
						</div>
					</div>
