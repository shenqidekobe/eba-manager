...
<div class="child_page"><!--内容外面的大框-->
    ...
    <div class="form_box" style="overflow: auto;">
        <form id="inputForm" action="create.jhtml" method="post" class="form form-horizontal">
            <div class="pag_div">
                ...
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-8 col-sm-7">
                        <input type="number" id="batchNo" min="1" class="input-text radius" name="batchNo"
                               maxlength="200">
                    </div>
                </div>
                <div class="row cl">
                    ...
                    <div class="formControls col-xs-8 col-sm-7">
                        <input type="number" id="num" name="num" min="1" class="input-text radius down_list">
                    </div>
                </div>
                ...
                <div class="footer_submit">
                    ...
                    <input class="btn radius cancel_B" type="button" value="${message("admin.common.back")}"
