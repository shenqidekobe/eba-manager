...
<html>
	<head>
		...
		<style>
			...
			.require_search{border:1px solid #f0f0f0;}
		</style>
	</head>
	<body >
		...
		<form id="listForm" action="orderNeedList.jhtml" method="get">
        ...
        <script type="text/javascript">
            ...
            function selectNeed(currThis){
                ...
                if($this.attr("checked")){
                    window.parent.addToNeedCache(needId);
                }
                if(!$this.attr("checked")){
                    window.parent.delFromNeedCache(needId);
                }
            }
            ...
            $().ready(function() {
                ...
                var cacheNeeds = window.parent.getNeedCache();
