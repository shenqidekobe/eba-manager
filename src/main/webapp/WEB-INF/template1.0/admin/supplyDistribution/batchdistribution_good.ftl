...
<html>
	<head>
		...
		<style>
			...
			.divGoodsSum h3,.goodsSumH3{
				margin:0px 0 0px 30px;font-size:14px;
			}
			.divGoodsSum p{
				text-indent: 50px;
				color:#333;
	...
	<body >
		<div class="" style="width:100%;">
			<form id="listForm" action="batchdistributionGoods.jhtml" method="get">
                ...
                <input type="hidden" id="needNum" name="needNum" value="${needNum}"/>
                <div class="divGoodsSum">
                	<h3 class="form_title">收货点数量</h3>
                	<p>${needNum}</p>
                </div>
                <h3 class="form_title goodsSumH3">商品数量</h3>
				<div class="hang_list">
