    ...
    <div class="customer-goods">
        ...
        <ul class="info_ul">
            <li class="li_info li_bot">
                ...
                <div class="input">
                    <input type="text" id="name" placeholder="请填入客户名称 必填" name="name" class="info" />
                </div>
            </li>
            <li class="li_info li_bot">
                <span class="label">联系方式</span>
                <div class="input">
                    <input type="text" id="tel" name="tel" value="" placeholder="此电话作为微信小程序登录账号 必填" class="info">
                </div>
            </li>
            <li class="li_info li_bot">
                <span class="label">收货人</span>
                <div class="input">
                    <input type="text" id="userName" placeholder="请填入收货人姓名 必填" name="userName" class="info" />
                </div>
            </li>
            <li class="li_info li_jiantou">
                <span class="label">客户地区</span>
                <div class="input">
                    <input type="text" class="goodsType_in" name="areaName" id="mobileSelect" class="info" placeholder="请选择客户所在地区 必选" unselectable="on" onfocus="this.blur()" readonly="readonly">
            ...
            <li class="li_info li_bot">
                ...
                <div class="input">
                    <input type="text" id="address" name="address" value=""  placeholder="请填写详细地址 必填">
                </div>
            </li>
    ...
    <div class="customer-info">
        ...
        <ul class="info_ul">
            <li class="li_info li_bot">
                ...
                <div class="input">
                    <input type="text" id="contacts" name="contacts" value="" placeholder="请填写联系人姓名 非必填" class="info">
                </div>
            </li>
            <li class="li_info li_bot">
                <span class="label">联系方式</span>
                <div class="input">
                    <input type="text" id="contactsTel" name="contactsTel" value="" placeholder="请填写联系人电话 非必填" class="info">
                </div>
            </li>
            <li class="li_info">
    ...
    <div class="saleman-info">
        ...
        <ul class="info_ul">
            ...
            <li class="li_info li_jiantou">
                ...
                <div class="input">
                    <input type="text" id="prompt" class="info" unselectable="on" onfocus="this.blur()" readonly placeholder="请先选择部门">
