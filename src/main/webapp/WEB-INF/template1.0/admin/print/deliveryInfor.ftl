	...
	<body >
		...
		<div class="print_box">
			<div class="con_header">
				...
				<ul class="orderInfo">
					<li>
						<label class="order_lab">公司名称:</label><span>${order.member.need.supplier.name}</span>
					</li>
					<li>
					...
					<li>
						<label class="order_lab">收货点:</label><span>${order.member.need.name}</span>
					</li>
					<li>
					...
					<li>
						<label class="order_lab">收货点备注:</label><span>${order.member.need.description}</span>
					</li>
				</ul>
			</div>
			[#if order.member.need.type == 'general']
			<div class="qurenCode">
...
<!--				<div class="order_time"><p><span>2017/5/23</span><i>订单打印微商平台</i></p></div>-->
			</div>
