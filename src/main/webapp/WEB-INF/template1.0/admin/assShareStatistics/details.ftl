...
<head>
    ...
    <script>
        $(function(){
            ...
            //     $("#iframeList2").load(function () {
            //         var mainheight2 = $(this).contents().find("body>div").height();
            //         console.log(mainheight2);
            //         if(mainheight2<300){
            //             mainheight2 = 300;
            //         };
            //         $(this).height(mainheight2);
            //     });
            //     $("#iframeList2").prop("src",'userRecord.jhtml');
        ...
        <div class="form_box">
            <form class="form form-horizontal" id="form-article-add">
                ...
                <div id="tab-system" class="HuiTab">
                    <div class="tabBar cl">
                        <span><a href="userRecord.jhtml">基本信息</a></span>
                        <span class="tabTwo"><a href="userRecord.jhtml">访问记录</a></span>

                    </div>

                    <div class="tabCon"></div>
                    <div class="tabCon">
                        <form id="listForm" action="userRecord.jhtml" method="get">
