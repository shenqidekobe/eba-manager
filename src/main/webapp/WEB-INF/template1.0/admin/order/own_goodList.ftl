						...
						<table class="table table-border table-hover table_width">
							...
							<tbody>
								...
								<tr class="text-l" name="dataTr">
									...
									<td>
										<input type="number" id="quantity" min="${product.minOrderQuantity}" class="in_no input-text radius" value="${product.minOrderQuantity}" oninput="checkUpdateQuantity(${product.id},this);" onpropertychange="checkUpdateQuantity(${product.id},this);"/>
...
//			$(".list_t_tbody").css("height",heightObj);
			...
			function checkProduct(obj){
				...
				if ($(obj).is(':checked')) {
					...
					product.minOrderQuantity=$(obj).parent().parent().find("#quantity").attr("min");
