		...
		<table class="input">
			...
			<tr class="authorities">
				...
				<td>
					<span class="fieldSet">
						<label>
							<input type="checkbox" name="authorities" value="admin:supplier" />${message("admin.role.supplier")}
						</label>
					</span>
				</td>
			</tr>
			<tr class="authorities">
				...
				<td>
					<span class="fieldSet">
						<label>
							<input type="checkbox" name="authorities" value="admin:formalSupply" />${message("admin.role.formalSupply")}
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:supplyDistribution" />${message("admin.role.supplyDistribution")}
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:temporary" />${message("admin.role.temporary")}
						</label>
					</span>
				</td>
			</tr>
			<tr class="authorities">
				...
				<td>
					<span class="fieldSet">
						<label>
							<input type="checkbox" name="authorities" value="admin:order" />订货单
						</label>
						<label>
						...
						<label>
							<input type="checkbox" name="authorities" value="admin:ownOrder" />采购单
						</label>
					</span>
				</td>
			</tr>
			...
			<tr class="authorities">
				...
				<td>
					<span class="fieldSet">
						...
						<label>
							<input type="checkbox" name="authorities" value="admin:notice" />消息通知
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:enterpriseInfo" />企业信息
						</label>
					</span>
				</td>
			</tr>
            ...
            <tr class="authorities">
                ...
                <td>
					<span class="fieldSet">
						<label>
							<input type="checkbox" name="authorities" value="admin:need" />收货点管理
						</label>
					</span>
                </td>
            </tr>
            <tr class="authorities">
                ...
                <td>
					<span class="fieldSet">
						<label>
							<input type="radio" name="switchs" value="off" checked="checked" />否
							<input type="radio" name="switchs" value="on" />是
						</label>
					</span>
                </td>
            </tr>
