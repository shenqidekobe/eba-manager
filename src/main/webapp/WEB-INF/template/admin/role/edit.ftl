...
<title>${message("admin.role.edit")} - Powered By DreamForYou</title>
...
<body>
	...
	<form id="inputForm" action="update.jhtml" method="post">
		...
		<table class="input">
			...
			<tr class="authorities">
				<th>
					<a href="javascript:;" class="selectAll" title="${message("admin.role.selectAll")}">${message("admin.role.supplierGroup")}</a>
				</th>
				<td>
					<span class="fieldSet">
						<label>
							<input type="checkbox" name="authorities" value="admin:supplier" [#if role.authorities?seq_contains("admin:supplier")] checked="checked"[/#if]/>${message("admin.role.supplier")}
						</label>
					</span>
				</td>
			</tr>
			<tr class="authorities">
				<th>
					<a href="javascript:;" class="selectAll" title="${message("admin.role.selectAll")}">${message("admin.role.formalSupplyGroup")}</a>
				</th>
				<td>
					<span class="fieldSet">
						<label>
							<input type="checkbox" name="authorities" value="admin:formalSupply" [#if role.authorities?seq_contains("admin:formalSupply")] checked="checked"[/#if] />${message("admin.role.formalSupply")}
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:supplyDistribution" [#if role.authorities?seq_contains("admin:supplyDistribution")] checked="checked"[/#if] />${message("admin.role.supplyDistribution")}
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:temporary" [#if role.authorities?seq_contains("admin:temporary")] checked="checked"[/#if] />${message("admin.role.temporary")}
						</label>
					</span>
				</td>
			</tr>
			<tr class="authorities">
				...
				<td>
					<span class="fieldSet">
						<label>
							<input type="checkbox" name="authorities" value="admin:order"[#if role.authorities?seq_contains("admin:order")] checked="checked"[/#if] />订货单
						</label>
						<label>
						...
						<label>
							<input type="checkbox" name="authorities" value="admin:ownOrder"[#if role.authorities?seq_contains("admin:ownOrder")] checked="checked"[/#if] />采购单
						</label>
					</span>
				</td>
			</tr>
			...
			<tr class="authorities">
				...
				<td>
					<span class="fieldSet">
						...
						<label>
							<input type="checkbox" name="authorities" value="admin:notice"[#if role.authorities?seq_contains("admin:notice")] checked="checked"[/#if] />消息通知
						</label>
						<label>
							<input type="checkbox" name="authorities" value="admin:enterpriseInfo"[#if role.authorities?seq_contains("admin:enterpriseInfo")] checked="checked"[/#if] />企业信息
						</label>
					</span>
				</td>
			</tr>
            ...
            <tr class="authorities">
                <th>
                    <a href="javascript:;" class="selectAll" title="${message("admin.role.selectAll")}">收货点管理</a>
                </th>
                <td>
					<span class="fieldSet">
						<label>
							<input type="checkbox" name="authorities" value="admin:need" [#if role.authorities?seq_contains("admin:need")] checked="checked"[/#if] />收货点管理
						</label>
					</span>
                </td>
            </tr>
			 <tr class="authorities">
                <th>
                    <a href="javascript:;" class="selectAll" >对企业是否可用:</a>
                </th>
                <td>
					<span class="fieldSet">
						<label>
							<input type="radio" name="switchs" value="off"  [#if role.switchs == 'off'] checked="checked"[/#if] />否
							<input type="radio" name="switchs" value="on" [#if role.switchs == 'on'] checked="checked"[/#if]/>是
						</label>
