...
<title>${message("admin.goods.edit")} - Powered By DreamForYou</title>
...
$().ready(function() {
	...
	function buildProductTable(productValues) {
		...
		$.each(products, function(i, entries) {
			...
			var stock = productValue != null && productValue.stock != null ? productValue.stock : "999999999";
...
<body>
	...
	<form id="inputForm" action="update.jhtml" method="post" enctype="multipart/form-data">
		...
		<table class="input tabContent">
			<tr>
				<th><h1>${message("admin.goods.base")}</h1></th>
				<td colspan="3"></td>
			</tr>
			<tr>
				<th>
			...
			<tr>
				<th>
					${message("Goods.packagesNum")}:
				</th>
				<td>
					<input type="text" name="packagesNum" class="text" value="${goods.packagesNum}" maxlength="9" />
				</td>
				<th>
					${message("Goods.unit")}:
				</th>
				<td>
					<select id="unit" name="unit">
						<option value="">${message("admin.common.choose")}</option>
						<option value="box" [#if 'box' == goods.unit] selected="selected"[/#if]>${message("Goods.unit.box")}</option>
						<option value="bottle" [#if 'bottle' == goods.unit] selected="selected"[/#if]>${message("Goods.unit.bottle")}</option>
						<option value="bag" [#if 'bag' == goods.unit] selected="selected"[/#if]>${message("Goods.unit.bag")}</option>
						<option value="frame" [#if 'frame' == goods.unit] selected="selected"[/#if]>${message("Goods.unit.frame")}</option>
					</select>
				</td>
			</tr>
			<tr>
				<th>
					${message("Goods.shelfLife")}:
				</th>
				<td>
					<input type="text" name="shelfLife" class="text" maxlength="9" value="${goods.shelfLife}" />天
				</td>
				<th>
					${message("Goods.storageConditions")}:
				</th>
				<td>
					<select id="storageConditions" name="storageConditions">
						<option value="">${message("admin.common.choose")}</option>
						<option value="roomTemperature" [#if 'roomTemperature' == goods.storageConditions] selected="selected"[/#if]>${message("Goods.storageConditions.roomTemperature")}</option>
						<option value="refrigeration" [#if 'refrigeration' == goods.storageConditions] selected="selected"[/#if]>${message("Goods.storageConditions.refrigeration")}</option>
						<option value="frozen" [#if 'frozen' == goods.storageConditions] selected="selected"[/#if]>${message("Goods.storageConditions.frozen")}</option>
					</select>
				</td>
			</tr>
			<tr>
				...
				<td>
					...
					<select id="weightUnit" name="weightUnit">
						<option value="g" [#if 'g' == goods.weightUnit] selected="selected"[/#if]>${message("Goods.weightUnit.g")}</option>
						<option value="kg" [#if 'kg' == goods.weightUnit] selected="selected"[/#if]>${message("Goods.weightUnit.kg")}</option>
					</select>
				</td>
				<th>
					${message("Goods.volume")}:
				</th>
				<td>
					<input type="text" name="volume" class="text" maxlength="9" value="${goods.volume}" />
					<select id="volumeUnit" name="volumeUnit">
						<option value="cubicCentimeters" [#if 'cubicCentimeters' == goods.volumeUnit] selected="selected"[/#if]>${message("Goods.volume.cubicCentimeters")}</option>
						<option value="cubicMeter" [#if 'cubicMeter' == goods.volumeUnit] selected="selected"[/#if]>${message("Goods.volume.cubicMeter")}</option>
					</select>
				</td>
			</tr>
			<tr>
				<th>
					${message("Goods.nature")}:
				</th>
				<td>
					<select id="nature" name="nature">
						<option value="">${message("admin.common.choose")}</option>
						<option value="gas" [#if 'gas' == goods.nature] selected="selected"[/#if]>${message("Goods.nature.gas")}</option>
						<option value="solid" [#if 'solid' == goods.nature] selected="selected"[/#if]>${message("Goods.nature.solid")}</option>
						<option value="liquid" [#if 'liquid' == goods.nature] selected="selected"[/#if]>${message("Goods.nature.liquid")}</option>
					</select>
				</td>
                <th>
		...
		--]
		[#--<h1>${message("admin.goods.parameter")}</h1>
		...
		<h1>${message("admin.goods.attribute")} </h1>
		...
		<table class="input">
			<tr>
				<th><h1>${message("admin.goods.specification")} </h1></th>
				<td colspan="3"></td>
			</tr>
		</table>
