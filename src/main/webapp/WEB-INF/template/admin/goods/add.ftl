...
<title>${message("admin.goods.add")} - Powered By DreamForYou</title>
...
$().ready(function() {
	...
	function changeView() {
		if (hasSpecification) {
			...
			$cost.add($marketPrice).prop("disabled", false).closest("tr").show();
			switch ($type.val()) {
				case "general":
...
<body>
	...
	<form id="inputForm" action="save.jhtml" method="post" enctype="multipart/form-data">
		...
		<table class="input tabContent">
            <tr>
                <th>
                    <h1>${message("admin.goods.base")}</h1>
                </th>
                <td colspan="3">
                </td>
			...
			<tr>
				...
				<td>
					<input type="text" name="packagesNum" class="text" maxlength="9" />
				</td>
				<th>
					${message("Goods.unit")}:
				</th>
				<td>
					<select id="unit" name="unit">
						<option value="">${message("admin.common.choose")}</option>
						<option value="box">${message("Goods.unit.box")}</option>
						<option value="bottle">${message("Goods.unit.bottle")}</option>
						<option value="bag">${message("Goods.unit.bag")}</option>
						<option value="frame">${message("Goods.unit.frame")}</option>
					</select>
				</td>
			</tr>
			<tr>
				...
				<td>
					<input type="text" name="shelfLife" class="text" maxlength="9" /> 天
				</td>
				<th>
			...
			<tr>
				...
				<td>
					...
					<select id="weightUnit" name="weightUnit">
						<option value="g">${message("Goods.weightUnit.g")}</option>
						<option value="kg">${message("Goods.weightUnit.kg")}</option>
					</select>
				</td>
				<th>
				...
				<td>
					<input type="text" name="volume" class="text" maxlength="9" />
					<select id="volumeUnit" name="volumeUnit">
						<option value="cubicCentimeters">${message("Goods.volume.cubicCentimeters")}</option>
						<option value="cubicMeter">${message("Goods.volume.cubicMeter")}</option>
					</select>
				</td>
			</tr>
			<tr>
				...
				<td>
					<select id="nature" name="nature">
						<option value="">${message("admin.common.choose")}</option>
						<option value="gas">${message("Goods.nature.gas")}</option>
						<option value="solid">${message("Goods.nature.solid")}</option>
						<option value="liquid">${message("Goods.nature.liquid")}</option>
					</select>
				</td>
                <th>
			...
			<tr class="hidden">
				...
				<td>
					<input type="text" id="stock" name="product.stock" class="text" value="999999999" maxlength="9" />
				</td>
			</tr>
			...
			<tr>
				...
				<td colspan="3">
					<input type="text" id="price" name="product.price" class="text" value="0" maxlength="16" />
				</td>
			</tr>
        ...
        <table class="input tabContent">
            <tr>
                <th>
                    <h1>${message("admin.goods.specification")}</h1>
                </th>
                <td colspan="3">
                </td>
            </tr>
