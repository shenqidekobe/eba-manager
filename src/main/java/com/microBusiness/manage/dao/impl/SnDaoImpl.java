...
public class SnDaoImpl implements SnDao, InitializingBean {
	...
	private HiloOptimizer assGoodsHiloOptimizer;
	
	private HiloOptimizer relationHiloOptimizer;
	
	private HiloOptimizer cardHiloOptimizer;
	
	private HiloOptimizer goodsImageHiloOptimizer;
	...
	@Value("${sn.assGoods.prefix}")
	private String assGoodsPrefix;
	@Value("${sn.assGoods.maxLo}")
	private int assGoodsMaxLo;
	
	@Value("${sn.relation.prefix}")
	private String relationPrefix;
	@Value("${sn.relation.maxLo}")
	private int relationMaxLo;
	...
	@Value("${sn.goodsImage.prefix}")
	private String goodsImagePrefix;
	@Value("${sn.goodsImage.maxLo}")
	private int goodsImageMaxLo;
	...
	public void afterPropertiesSet() throws Exception {
		...
		assGoodsHiloOptimizer = new HiloOptimizer(Sn.Type.ass_goods, assGoodsPrefix, assGoodsMaxLo);
		relationHiloOptimizer = new HiloOptimizer(Sn.Type.relation, relationPrefix, relationMaxLo);
		cardHiloOptimizer=new HiloOptimizer(Sn.Type.card, cardPrefix, cardMaxLo);
		goodsImageHiloOptimizer=new HiloOptimizer(Sn.Type.goodsImage, goodsImagePrefix, goodsImageMaxLo);
	}
	...
	public String generate(Sn.Type type) {
		...
		case ass_goods:
			return assGoodsHiloOptimizer.generate();
		case relation:
			return relationHiloOptimizer.generate();
		case card:
			return cardHiloOptimizer.generate();
		case goodsImage:
			return goodsImageHiloOptimizer.generate();
		}
		return null;
	}
