...
public class RoleController extends BaseController {
	...
	public String add(ModelMap model) {
		model.addAttribute("currSupplier", this.getCurrentSupplier());
	...
	public String save(Role role, RedirectAttributes redirectAttributes) {
		...
		role.setAdmins(null);
		role.setSupplier(this.getCurrentSupplier());
	...
	public String update(Role role, RedirectAttributes redirectAttributes) {
		...
		roleService.update(role, "isSystem", "admins","supplier");
		addFlashMessage(redirectAttributes, SUCCESS_MESSAGE);
		return "redirect:list.jhtml";
	}
	...
	public String list(Pageable pageable, ModelMap model) {
		model.addAttribute("page", roleService.findPage(pageable,this.getCurrentSupplier()));
		model.addAttribute("currSupplier", this.getCurrentSupplier());
